...
# --- TODO: Implement the high-pass filter function ---
def apply_highpass(data, cutoff, fs=Fs, order=4):
    ...
    """
    # --- HINT:
    # 1. Calculate Nyquist frequency: nyq = 0.5 * fs
    # 2. Normalize the cutoff frequency: norm_cutoff = cutoff / nyq
    # 3. Create the filter: b, a = butter(order, norm_cutoff, btype='high')
    # 4. Apply the filter: return filtfilt(b, a, data)
    
    pass  # TODO: Replace this with the actual implementation
...
class HighPassApp:
    def __init__(self, master):
        ...
        self.cutoff_default = 50000  # default cutoff
    ...
    def update_plot(self, cutoff):
        ...
        # TODO: Call apply_highpass with the signal and cutoff
